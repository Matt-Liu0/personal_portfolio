      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link href="/contact" className="border border-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-50 transition flex items-center">
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-8">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4 mt-4">
                <Link href="https://github.com/Matt-Liu0" className="text-blue-100 hover:text-white transition">
                ...
                <Link href="https://linkedin.com/in/ziyu-liu-3001572b4" className="text-blue-100 hover:text-white transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
